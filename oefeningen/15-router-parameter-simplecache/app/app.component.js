System.register(['angular2/core', "./city.service", 'angular2/router'], function(exports_1) {
    ...
    var core_1, city_service_1, router_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
                ...
                AppComponent.prototype.getCities = function () {
                    ...
                    if (!this.cities) {
                        this.cityService.getCities()
                            ...
                            _this.cityService.cache = _this.cities; // caching van cities
